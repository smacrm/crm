 ...
 * @author daind
 */
@Job(name = "ExampleConcurrentExecutionJob", group = "EXAMPLE_001", startOnLoad = false,
        trigger = @Trigger(cron = "0/5 * * * * ?", description = "will run every five seconds"),
        description = "")
public class ExampleConcurrentExecutionJob extends ConcurrentExecutionJob {
    private static final Logger MAINLOGGER = LoggerFactory.getLogger(ExampleConcurrentExecutionJob.class);
    @Override
